...
func TestClaudeStreamErrorEventRemainsZeroOutputRetryable(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	info := &relaycommon.RelayInfo{ChannelMeta: &relaycommon.ChannelMeta{UpstreamModelName: "claude-test"}, RelayFormat: types.RelayFormatOpenAI}
