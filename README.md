...
| `RELAY_RESPONSE_HEADER_TIMEOUT` | Maximum time to wait for upstream response headers, seconds. Defaults to `1800`; set `0` to disable. Streaming bodies are not affected | `1800` |
