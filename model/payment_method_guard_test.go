...
func TestCompleteSubscriptionOrder_RejectsMismatchedPaymentProvider(t *testing.T) {
	...
	err := CompleteSubscriptionOrder("sub-guard-order", `{"provider":"epay"}`, PaymentProviderEpay, "alipay", SubscriptionPaymentConfirmation{Amount: "9.99", Product: "SUB:Guard Plan"})
	require.ErrorIs(t, err, ErrPaymentMethodMismatch)
